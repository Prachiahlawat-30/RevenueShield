    ...
    <div className="rounded-[16px] border border-white/[0.06] bg-[#12161F] p-6 sm:p-8 shadow-fintech-card">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-5 border-b border-white/[0.06]">
        <div className="flex items-center gap-2.5">
          <span className="h-5 px-2 rounded-full inline-flex items-center gap-1.5 text-[10px] font-medium bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/20">
            <span className="w-1.5 h-1.5 rounded-full bg-[#10B981]" />
            Settled Ledger
          </span>
          <span className="text-[13px] text-[#9CA3B0] hidden sm:inline-block">
            Continuous Revenue Capture
          </span>
        </div>

        <div className="flex items-center gap-2">
          <span className="h-5 px-2 rounded-full inline-flex items-center text-[10px] font-medium text-[#9CA3B0] bg-white/[0.05] border border-white/[0.08]">
      ...
      <div className="py-6 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap items-baseline gap-3">
            <h1 className="text-[40px] sm:text-[44px] font-semibold tracking-tight text-[#F5F6FA] tabular-nums">
              {formattedAmount}
            </h1>
            <span className="text-xl font-normal text-[#9CA3B0]">
              recovered
            </span>

            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/20 tabular-nums">
              +{recoveryRate.toFixed(1)}% recovery rate
            </span>
          </div>

          <p className="text-[14px] font-normal text-[#9CA3B0] max-w-2xl leading-relaxed pt-1">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          {onNavigateToTab && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-[10px] text-xs font-medium text-[#F5F6FA] bg-[#171C28] hover:bg-[#1C2333] border border-white/[0.08] transition-colors cursor-pointer shadow-sm"
            >
              <span>Settlement ledger</span>
              <ArrowUpRight className="w-3.5 h-3.5 text-[#9CA3B0]" />
            </button>
          )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-5 border-t border-white/[0.06]">
        <div className="p-4 rounded-[12px] bg-[#0E121A] border border-white/[0.04] space-y-1">
          <span className="text-[11px] font-medium tracking-[0.04em] text-[#6B7280] uppercase block">
            Portfolio recovery rate
          </span>
          <div className="flex items-baseline gap-2">
            <span className="text-[20px] font-semibold text-[#F5F6FA] tabular-nums">
              {recoveryRate.toFixed(1)}%
            </span>
            <span className="text-xs text-[#10B981] tabular-nums">
              vs 18.2% baseline
            </span>
          </div>
