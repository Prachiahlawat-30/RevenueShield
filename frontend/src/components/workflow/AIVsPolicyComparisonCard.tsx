    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-white/[0.06]">
        <div>
          ...
          <h3 className="text-[18px] font-semibold text-[#F5F6FA] mt-1 tracking-tight">
            AI Proposes. Policy Decides.
          </h3>
          <p className="text-[13px] text-[#9CA3B0] mt-0.5 max-w-3xl leading-relaxed">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-white/[0.04] text-[#9CA3B0] border border-white/[0.06]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-stretch">
        ...
        {/* ========================================================= */}
        <div className="flex flex-col justify-between rounded-[14px] border border-white/[0.06] bg-[#0E121A] p-5 space-y-4">
          <div className="space-y-4">
            {/* Header */}
            <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-[10px] bg-[#8B7CF6]/15 flex items-center justify-center text-[#8B7CF6] shrink-0">
                  <Brain className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-xs font-semibold uppercase tracking-[0.04em] text-[#F5F6FA]">
                    AI recommendation
                  </h4>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 rounded-[10px] bg-[#12161F] border border-white/[0.06]">
              <div>
            ...
            {/* Reason */}
            <div className="space-y-1 p-3.5 rounded-[10px] bg-[#12161F] border border-white/[0.06]">
              <span className="text-[11px] font-medium tracking-[0.04em] text-[#6B7280] uppercase block">
                Diagnosis reason
              </span>
          ...
          {/* AI Footnote */}
          <div className="pt-3 border-t border-white/[0.06] text-[11px] text-[#6B7280] flex items-center gap-1.5">
        ...
        <div className="flex flex-col justify-between rounded-[14px] border border-white/[0.06] bg-[#0E121A] p-5 space-y-4">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
              ...
              <span className="h-5 px-2 rounded-full inline-flex items-center text-[10px] font-medium bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/20">
                Rule check: Passed
              </span>
            </div>

            {/* Checklist */}
            <div className="space-y-2 p-3.5 rounded-[10px] bg-[#12161F] border border-white/[0.06]">
              <span className="text-[11px] font-medium tracking-[0.04em] text-[#6B7280] uppercase block pb-1">
                Enforced guardrails
              </span>
              <div className="space-y-1.5 text-xs">
                <div className="flex items-center gap-2 text-[#9CA3B0]">
                  <span className="w-3.5 h-3.5 rounded-full bg-[#10B981]/10 text-[#10B981] flex items-center justify-center text-[9px] font-bold">
                    ✓
                  </span>
            ...
            {executionSuccess ? (
              <div className="space-y-2">
                <div className="p-3 rounded-[10px] bg-[#10B981]/10 border border-[#10B981]/20 text-[#10B981] font-medium text-xs flex items-center justify-center gap-2">
                  <CheckCircle2 className="w-4 h-4" />
                  <span>{executionMessage || 'Action executed & funds settled'}</span>
                </div>
                {onNavigateToTab && (
                  <div className="flex items-center justify-between text-xs px-1">
                    <span className="text-[11px] text-[#6B7280]">Recorded in ledger</span>
                    <button
                      onClick={() => onNavigateToTab('workflow')}
                      className="inline-flex items-center gap-1 text-xs font-medium text-[#3B82F6] hover:text-[#2563EB] cursor-pointer"
                    >
