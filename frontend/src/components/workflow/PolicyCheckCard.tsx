    ...
    return (
      <div className="flex h-72 w-full items-center justify-center rounded-[16px] border border-dashed border-white/[0.08] bg-[#12161F] p-6 text-center text-[#6B7280] shadow-fintech-card">
        <div className="flex flex-col items-center gap-2">
          <ShieldCheck className="h-7 w-7 text-[#6B7280]" />
          <p className="text-xs text-[#9CA3B0]">Policy evaluation will validate proposals before execution.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col justify-between rounded-[16px] border border-white/[0.06] bg-[#12161F] p-6 shadow-fintech-card space-y-4">
      <div className="space-y-4">
        ...
        {/* Action Decision Box */}
        <div className="rounded-[10px] border border-white/[0.04] bg-[#0E121A] p-3.5">
          <div className="flex items-center justify-between text-xs">
            <div>
              <span className="text-[11px] font-medium tracking-[0.04em] text-[#6B7280] uppercase block">
                AI suggested action
              </span>
              <p className="font-medium text-[#9CA3B0] mt-0.5">
            ...
            <div className="text-right">
              ...
              <p className="font-semibold text-[#F5F6FA] mt-0.5">
          ...
          {isOverridden && (
            <div className="mt-2.5 flex items-center gap-2 rounded-[8px] bg-[#E8A33D]/10 p-2 text-xs text-[#E8A33D] border border-[#E8A33D]/20">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1.5 text-xs">
            {defaultPolicyChecks.map((check, idx) => (
              <div
                key={idx}
                className="flex items-center justify-between rounded-[10px] border border-white/[0.04] bg-[#0E121A] px-3.5 py-2 text-xs"
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#9CA3B0]">{check.label}</span>
                </div>
                <span className="h-4.5 px-1.5 rounded-full inline-flex items-center text-[9px] font-medium bg-white/[0.04] text-[#6B7280] border border-white/[0.06]">
                  Verified
                </span>
              </div>
            ))}
      ...
      <div className="pt-3 border-t border-white/[0.06] flex items-center justify-between text-[11px] text-[#6B7280]">
        <span>Engine: <strong className="text-[#9CA3B0] font-medium">PolicyEngine v2.4</strong></span>
